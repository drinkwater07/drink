...
public class PoliceSmokeTest82 {
...
{
	testContext.setAttribute("moduleName", "PoliceSmokeTest82");
  	...
  	public void SmokeTestScripts_Traffic_(ITestContext testContext) throws Exception {
  		...
  		for (int i = 1; i <= cou; i++) {
  			...
  			while (res) {
  			 ...
  			 if (PoliceData.getPoliceSmokeModuleValue("Screen" + i + "").equalsIgnoreCase("Traffic Interface Log")) 
  				{
  					objectIdentification.windowHandle.switchToMainWindowScreenTab(PoliceData.getPoliceSmokeModuleValue("Screen" + i + ""));
