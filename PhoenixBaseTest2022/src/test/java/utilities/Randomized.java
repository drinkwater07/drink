...
public class Randomized {
      ...
      public static String convertOneFormatToAnother(String date)
      {

      StringBuffer stringBuffer = new StringBuffer();
      Date now = null;
      try {
      now = new SimpleDateFormat("MM/dd/yyyy").parse(date);
      } catch (ParseException e) {
      ...
      public static String getFutureDayNumber1(int NoOfDays)
      {
    	  SimpleDateFormat dateStrFuture = new SimpleDateFormat("dd");
    	  Calendar cal = Calendar.getInstance();
    	  cal.add(Calendar.DATE, NoOfDays); // +days
    	  return dateStrFuture.format(cal.getTime()).toString();
	  ...
	  public static int getRandomEvenNumber(int numLen)
		 ...
		 /// <summary>
		   ...
		   public static int getRandomDropDownValue(int unitLength)
	        {
			   int size = unitLength - 1;
	            Random rannum1 = new Random();
	            int result1 = rannum1.nextInt(size);
	            if (result1 < 1)
	                result1 = 1;
	            return result1;
	        }
		   ...
		   public static String getRandomPhoneNumbers()
           {
               ...
               for (int i = 0; i < 10; i++)
               {
                      nums.append(random.nextInt(9));
               }
               String value = new String(nums);
               return value;
           } 
		   ...
		   public static String randomIdentifierGenerate(int len) {
