...
public class BaseSmokeTest45 {
	...
	@BeforeSuite(groups={"Base45","CMS45"})
	...
	@BeforeMethod(groups={"Base45","CMS45"})
	public void beforeMethodRecords(ITestContext testContext) {
		testContext.setAttribute("moduleName", "BaseSmokeTest45");
	           ...
	           try {
	            ...
	            if(BaseData.getBaseSmokeModuleValue("Screen"+i+"").equalsIgnoreCase("Schedule Search"))
	            {
	            	...
	            	catch(Exception e)
	            	{
	            		 ...
	            		 objectIdentification.smokeTest.saveAndCloseTheScreenWithYesButton(BaseData.getBaseSmokeModuleValue("EntryScreen"+i+""));
	 	                objectIdentification.windowHandle.switchToMainWindow();
	            		 res = false;
	 		            break;
	            	}
...
public void SettingsSysParameterJurisSmokeTestScripts(ITestContext testContext) throws Exception
{
  ...
  else
  {
    ...
    @AfterMethod(groups={"Base45","CMS45"})
...
//  	  objectIdentification.windowHandle.focusOnActiveElementAndSwitch();
    ...
    @AfterSuite(groups={"Base45","CMS45"})
